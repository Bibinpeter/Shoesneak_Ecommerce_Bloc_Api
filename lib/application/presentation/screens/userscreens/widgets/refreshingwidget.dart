...
class _WarpIndicatorState extends State<WarpIndicator> with SingleTickerProviderStateMixin {
  ...
  late Color _skyColor; // Define _skyColor variable
  ...
  void initState() {
    ...
    _skyColor = Colors.white; // Initialize _skyColor to default value
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return CustomRefreshIndicator(
      ...
      builder: (
        ...
        _skyColor = _state == WarpAnimationState.playing ? Colors.black.withOpacity(0.8): Colors.white; // Update _skyColor based on state
        return Stack(
          children: <Widget>[
            AnimatedBuilder(
