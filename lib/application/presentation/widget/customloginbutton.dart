...
class CustomRoundedLoadingButtonS extends StatefulWidget {
  ...
  const CustomRoundedLoadingButtonS({
    Key? key,
...
class _CustomRoundedLoadingButtonState extends State<CustomRoundedLoadingButtonS> {
